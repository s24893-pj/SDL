# SDL  (Kod znajduje się w branchu "master", z uwagi na to że u mnie wystąpił problem i musiałem korzystać ze ścieżki absolutnej wymagana jest zmiana ścieżki do plików "BMP")
